...
player1_words = prompt_for_word(challenge_word)
player2_words = prompt_for_word(challenge_word)

print('Player 1 Results:')
player1_unique = player1_words - player2_words
print('{} gussses, {} unique'.format(len(player1_words), len(player1_unique)))
output_results(player1_unique)
print('-' * 10)
print('Player 2 Results:')
player2_unique = player2_words - player1_words
print('{} gussses, {} unique'.format(len(player2_words), len(player2_unique)))
